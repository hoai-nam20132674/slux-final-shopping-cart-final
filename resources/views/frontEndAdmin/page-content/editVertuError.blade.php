	...
	<div class="content-area py-1">
		<div class="container-fluid">
			...
			<ol class="breadcrumb no-bg mb-1">
				...
				<li class="breadcrumb-item"><a href="{{URL::route('getListVertuError')}}">Dịch vụ sửa chữa nokia 8800</a></li>
			...
			<div class="box box-block bg-white">
		    	...
		    	@endif
				<form action="{{URL::route('postEditVertuError',$vertu_errors->id)}}" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-9">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="error" placeholder="Nhập tiên lỗi" value="{{$vertu_errors->error}}" required>
							</div>
							
							<div class="form-group">
								<label for="exampleInputEmail1">Nội dung sửa chữa</label>
								<input type="text" class="form-control" name="repair_description" placeholder="Mô tả dịch vụ" value="{{$vertu_errors->repair_description}}" required>
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Giá dự kiến</label>
								<input type="text" class="form-control" name="price" placeholder="Báo giá dự kiến" value="{{$vertu_errors->price}}">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Bảo hành</label>
								<input type="text" class="form-control" name="warranty" placeholder="Thời gian bảo hành" value="{{$vertu_errors->warranty}}">
							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Link bài tin tức</label>
								<input type="text" class="form-control" name="blog_url" placeholder="Link bài tin tức" value="{{$vertu_errors->blog_url}}">
							</div>
