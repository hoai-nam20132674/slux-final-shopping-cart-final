	...
	<div class="content-area py-1">
		<div class="container-fluid">
			...
			<div class="box box-block bg-white">
		    	...
		    	@endif
				<form action="{{URL::route('postAddUser')}}" method="POST" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-md-9">
							...
							<div class="form-group">
								...
								<input type="password" class="form-control" name="cpassword" placeholder="nhập lại password" value="{{old('cpassword')}}">
							</div>
							<div class="form-group">
				                <label>Phân quyền</label>
				                <select class="form-control" name="role">
				                    <option value="0">Admin master</option>
				                    <option value="1">nhân viên maketting</option>
				                    <option value="1">nhân viên kỹ thuật</option>
				                </select>
				            </div>
						</div>
					</div>
